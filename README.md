...
Ther are 4 major parts should be run in this order AND in the same environment: 
...
3. LDA Plots
This code is used to both run and plot the results of a Linear Discriminant Analysis of the RF results combined with track features to discrimiate if locomotor states from various strains are similar or different.
4. Worm Track Plot
